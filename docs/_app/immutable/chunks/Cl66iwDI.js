import { b as A, g as T, e as I, am as Q, aZ as qe, a_ as gt } from "./CYmiEaEH.js"
import { w as be, o as Ne } from "./DXQ0fkFu.js"
class ke {
  constructor(t, n) {
...
window.fetch = (e, t) => ((e instanceof Request ? e.method : t?.method || "GET") !== "GET" && F.delete(Re(e)), bt(e, t))
const F = new Map()
function kt(e, t) {
  const n = Re(e, t),
  ...
  if (a?.textContent) {
    ...
    return (o && F.set(n, { body: r, init: s, ttl: 1e3 * Number(o) }), a.getAttribute("data-b64") !== null && (r = yt(r)), Promise.resolve(new Response(r, s)))
  }
      ...
      e === "/"
        ...
        : new RegExp(
            `^${Lt(e)
              .map((a) => {
                const r = /^\[\.\.\.(\w+)(?:=(\w+))?\]$/.exec(a)
                if (r) return (t.push({ name: r[1], matcher: r[2], optional: !1, rest: !0, chained: !0 }), "(?:/([^]*))?")
                const s = /^\[\[(\w+)(?:=(\w+))?\]\]$/.exec(a)
                ...
                return (
                  ...
                  o
                    .map((c, l) => {
                      if (l % 2) {
                        if (c.startsWith("x+")) return pe(String.fromCharCode(parseInt(c.slice(2), 16)))
                        if (c.startsWith("u+"))
                          return pe(
                            String.fromCharCode(
                              ...c
                        ...
                        const f = St.exec(c),
                          [, h, w, u, g] = f
                        return (
                          t.push({ name: u, matcher: g, optional: !!h, rest: !!w, chained: w ? l === 1 && o[0] === "" : !1 }),
                          w ? "([^]*?)" : h ? "([^/]*)?" : "([^/]+?)"
                        )
                      }
                      return pe(c)
...
function At({ nodes: e, server_loads: t, dictionary: n, matchers: a }) {
  ...
  return Object.entries(n).map(([i, [c, l, f]]) => {
    const { pattern: h, params: w } = Rt(i),
      u = {
        id: i,
        exec: (g) => {
          const _ = h.exec(g)
          if (_) return Ut(_, w, a)
        },
...
const L = globalThis.__sveltekit_wqriqn?.base ?? "/ElementsUI",
  Tt = globalThis.__sveltekit_wqriqn?.assets ?? L ?? "",
  It = "1762240078717",
...
function Pt() {
  ...
  async function a() {
    clearTimeout(n)
    try {
      const r = await fetch(`${Tt}/_app/version.json`, { headers: { pragma: "no-cache", "cache-control": "no-cache" } })
      if (!r.ok) return !1
...
function ue(e, t, n) {
  return e.origin !== ce || !e.pathname.startsWith(t)
    ? !0
    : n
      ? !(e.pathname === t + "/" || e.pathname === t + "/index.html" || (e.protocol === "file:" && e.pathname.replace(/\/[^/]+\.html?$/, "") === t))
      : !1
}
function on(e) {}
...
let k, Y, ge
const qt = Ne.toString().includes("$$") || /function \w+\(\) \{\}/.test(Ne.toString())
qt
  ? ((k = { data: {}, form: null, error: null, params: {}, route: { id: null }, state: {}, status: -1, url: new URL("https://example.com") }),
    (Y = { current: null }),
    (ge = { current: !1 }))
  : ((k = new (class {
      #e = A({})
...
async function un(e, t, n) {
  ;(globalThis.__sveltekit_wqriqn?.data && globalThis.__sveltekit_wqriqn.data,
    ...
    (y = history.state?.[B]),
    (x = history.state?.[W]),
    y || ((y = x = Date.now()), history.replaceState({ ...history.state, [B]: y, [W]: x }, "")))
  const a = N[y]
  function r() {
    a && ((history.scrollRestoration = "manual"), scrollTo(a.x, a.y))
  }
  ;(n ? (r(), await Qt(ve, n)) : (await K({ type: "enter", url: xe(v.hash ? nn(new URL(location.href)) : location.href), replace_state: !0 }), r()), Zt())
}
function Bt() {
  ;((ne.length = 0), (Te = !1))
}
...
function Ge() {
  ;(Ue(y), De(ze, N), st(x), De(Ye, z))
}
async function ct(e, t, n, a) {
  let r
  ;(t.invalidateAll && nt(),
    await K({
      type: "goto",
      ...
      nav_token: a,
      accept: () => {
        ;(t.invalidateAll && ((Te = !0), (r = [...Fe.keys()])), t.invalidate && t.invalidate.forEach(Xt))
      },
    }),
    t.invalidateAll &&
      Q()
...
async function Kt(e) {
  if (e.id !== R?.id) {
    ...
    if (
      (oe.add(t),
      (R = { id: e.id, token: t, promise: ut({ ...e, preload: t }).then((n) => (oe.delete(t), n.type === "loaded" && n.state.error && nt(), n)), fork: null }),
      qe)
    ) {
      const n = R
      n.fork = n.promise.then((a) => {
        if (n === R && a.type === "loaded")
          try {
            return qe(() => {
              ;(Ie.$set(a.props), et(a.props.page))
            })
          } catch {}
        return null
      })
...
async function lt(e, t, n) {
  ...
  if (
    ...
    (Ie = new v.root({ target: t, props: { ...e.props, stores: C, components: ae }, hydrate: n, sync: !1 })),
...
function se({ url: e, params: t, branch: n, status: a, error: r, route: s, form: o }) {
  ...
  const c = {
    ...
    props: { constructors: Ct(n).map((u) => u.node.component), page: je(k) },
  }
  ...
  for (let u = 0; u < Math.max(n.length, m.branch.length); u += 1) {
    const g = n[u],
      _ = m.branch[u]
    ;(g?.data !== _?.data && (f = !0), g && ((l = { ...l, ...g.data }), f && (c.props[`data_${h}`] = l), (h += 1)))
  }
  return (
    (!m.url || e.href !== m.url.href || m.error !== r || (o !== void 0 && o !== k.form) || f) &&
      (c.props.page = { error: r, params: t, route: { id: s?.id ?? null }, state: {}, status: a, url: new URL(e), form: o ?? null, data: f ? l : k.data }),
    c
  )
}
...
function Mt(e, t, n) {
  ...
  const s = re ? Et(a, r.href, t) : kt(a, t)
    ...
    return p[1] === E?.loader && !Ft(u, h, f, w, E.universal?.uses, a)
      ...
      : ((u = !0),
        Oe({
          ...
          parent: async () => {
            const P = {}
            for (let U = 0; U < d; U += 1) Object.assign(P, (await g[U])?.data)
            return P
          },
          server_data_node: Pe(p[0] ? { type: "skip" } : null, p[0] ? E?.server : void 0),
        }))
  })
  ...
  for (let p = 0; p < l.length; p += 1)
    if (l[p])
      try {
        ...
        const P = await Yt(p, _, o)
        return P ? se({ url: n, params: a, branch: _.slice(0, P.idx).concat(P.node), status: E, error: S, route: r }) : await dt(n, { id: r.id }, S, E)
      }
    else _.push(void 0)
  return se({ url: n, params: a, branch: _, status: 200, error: null, route: r, form: t ? void 0 : null })
}
...
async function $e({ status: e, error: t, url: n, route: a }) {
  ...
  let s = null
  try {
    const o = await Oe({ loader: we, url: n, params: r, route: a, parent: () => Promise.resolve({}), server_data_node: Pe(s) }),
      i = { node: await te(), loader: te, universal: null, server: null, data: null }
    return se({ url: n, params: r, branch: [o, i], status: e, error: t, route: null })
  } catch (o) {
    if (o instanceof Ee) return ct(new URL(o.location, location.href), {}, 0)
    throw o
  }
}
async function zt(e) {
...
async function fe(e, t) {
  if (e && !ue(e, L, v.hash)) {
    ...
    for (const r of Ae) {
      const s = r.exec(a)
      if (s) return { id: ie(e), invalidating: t, route: r, params: wt(s), url: e }
    }
  }
}
function Ht(e) {
  return _t(v.hash ? e.hash.replace(/^#/, "").replace(/[?#].+/, "") : e.pathname.slice(L.length)) || "/"
}
function ie(e) {
...
async function K({
  ...
  const u = await fe(t, !1),
    g = e === "enter" ? Ce(m, u, t, e) : ft({ url: t, type: e, delta: n?.delta, intent: u, event: h })
  if (!g) {
    ;(f(), q === c && (q = w))
    return
  }
  const _ = y,
    p = x
  ;(l(), (J = !0), re && g.navigation.type !== "enter" && C.navigating.set((Y.current = g.navigation)))
  let d = u && (await ut(u))
  if (!d) {
    if (ue(t, L, v.hash)) return await H(t, s)
    d = await dt(t, { id: null }, await X(new Se(404, "Not Found", `Not found: ${t.pathname}`), { url: t, params: {}, route: { id: null } }), 404, s)
  }
  ...
  } else d.props.page.status >= 400 && (await C.updated.check()) && (await tt(), await H(t, s))
  if ((Bt(), Ue(_), st(p), d.props.page.url.pathname !== t.pathname && (t.pathname = d.props.page.url.pathname), (o = n ? n.state : o), !n)) {
    const b = s ? 0 : 1,
      D = { [B]: (y += b), [W]: (x += b), [He]: o }
    ;((s ? history.replaceState : history.pushState).call(history, D, "", t), s || Dt(y, x))
  }
  const E = R?.fork
  ;((R = null), (d.props.page.state = o))
  let S
  if (re) {
    const b = (await Promise.all(Array.from(Vt, ($) => $(g.navigation)))).filter(($) => typeof $ == "function")
    if (b.length > 0) {
      let $ = function () {
        b.forEach((de) => {
          G.delete(de)
    ...
    const D = E && (await E)
    ;(D ? (S = D.commit()) : (Ie.$set(d.props), et(d.props.page), (S = gt?.())), (ot = !0))
  } else await lt(d, ve, !1)
  const { activeElement: P } = document
  ;(await S, await Q(), await Q())
...
async function dt(e, t, n, a, r) {
  return e.origin === ce && e.pathname === location.pathname && !rt ? await $e({ status: a, error: n, url: e, route: t }) : await H(e, r)
}
function Jt() {
  let e, t, n
  ...
  const r = new IntersectionObserver(
    (i) => {
      for (const c of i) c.isIntersecting && (me(new URL(c.target.href)), r.unobserve(c.target))
    },
    { threshold: 0 },
  )
  async function s(i, c) {
    const l = Xe(i, O),
      f = l === t && c >= n
    if (!l || f) return
    const { url: h, external: w, download: u } = _e(l, L, v.hash)
    if (w || u) return
    const g = ee(l),
      _ = h && ie(m.url) === ie(h)
    if (!(g.reload || _))
  ...
  function o() {
    ...
    for (const i of O.querySelectorAll("a")) {
      const { url: c, external: l, download: f } = _e(i, L, v.hash)
      if (l || f) continue
      const h = ee(i)
      h.reload || (h.preload_code === j.viewport && r.observe(i), h.preload_code === j.eager && me(c))
    }
  }
  ;(G.add(o), o())
}
...
function fn(e, t = {}) {
  return ((e = new URL(xe(e))), e.origin !== ce ? Promise.reject(new Error("goto: invalid URL")) : ct(e, t, 0))
}
function Xt(e) {
...
function Zt() {
  ;((history.scrollRestoration = "manual"),
    addEventListener("beforeunload", (t) => {
      let n = !1
      if ((Ge(), !J)) {
        const a = Ce(m, void 0, null, "leave"),
          r = {
            ...a.navigation,
            cancel: () => {
    ...
    O.addEventListener("click", async (t) => {
      ...
      if (!n) return
      const { url: a, external: r, target: s, download: o } = _e(n, L, v.hash)
      if (!a) return
      if (s === "_parent" || s === "_top") {
      ...
      const [l, f] = (v.hash ? a.hash.replace(/^#/, "") : a.href).split("#"),
        h = l === he(location)
      if (r || (i.reload && (!h || !f))) {
        ft({ url: a, type: "link", event: t }) ? (J = !0) : t.preventDefault()
        return
      }
      if (f !== void 0 && h) {
        ...
        if (((M = !0), Ue(y), e(a), !i.replace_state)) return
        M = !1
      }
      ;(t.preventDefault(),
        await new Promise((w) => {
    ...
    O.addEventListener("submit", (t) => {
      ...
      ;((o.search = new URLSearchParams(l).toString()),
        K({ type: "form", url: o, keepfocus: c.keepfocus, noscroll: c.noscroll, replace_state: c.replace_state ?? o.href === location.href, event: t }))
    }),
      ...
      if (!ye) {
        if (t.state?.[B]) {
          ...
          const a = N[n],
            ...
            o = t.state[W],
            i = m.url ? he(location) === he(m.url) : !1
          if (o === x && (ot || i)) {
            ;(r !== k.state && (k.state = r), e(s), (N[y] = le()), a && scrollTo(a.x, a.y), (y = n))
            return
          }
          const l = n - y
          await K({
    ...
    addEventListener("hashchange", () => {
      M && ((M = !1), history.replaceState({ ...history.state, [B]: ++y, [W]: x }, "", location.href))
    }))
...
async function Qt(e, { status: t = 200, error: n, node_ids: a, params: r, route: s, server_route: o, data: i, form: c }) {
  ...
  let f
  ;(({ params: r = {}, route: s = { id: null } } = (await fe(l, !1)) || {}), (f = Ae.find(({ id: u }) => u === s.id)))
  let h,
    w = !0
  try {
    ...
    ;((h = await $e({ status: Le(u), error: await X(u, { url: l, params: r, route: s }), url: l, route: s })), (e.textContent = ""), (w = !1))
  }
  ;(h.props.page && (h.props.page.state = {}), await lt(h, e, w))
}
function en(e) {
  return {
  ...
  if (n) n.focus()
    ...
    if (a && document.getElementById(a)) {
      ...
      setTimeout(() => {
        ...
        ;((ye = !0), location.replace(`#${a}`), v.hash && location.replace(e.hash), history.replaceState(i, "", e.hash), scrollTo(s, o), (ye = !1))
      })
    } else {
      const s = document.body,
        o = s.getAttribute("tabindex")
      ;((s.tabIndex = -1), s.focus({ preventScroll: !0, focusVisible: !1 }), o !== null ? s.setAttribute("tabindex", o) : s.removeAttribute("tabindex"))
    }
...
export { un as a, fn as g, on as l, k as p, C as s }
