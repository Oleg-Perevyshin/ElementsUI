...
const translations: Translations = {
  ru: {
    ...
    "constructor.props.tablecolumn.settings": "Настройки колонки",
    ...
    "constructor.props.table.select.keys.info":
      "Ключ колонки, содержащей серийный номер модуля; поле может быть пустым: к каждой строке применится серийный номер изделия",
