...
<div class={twMerge(`flex flex-col items-center gap-1`, wrapperClass)}>
  ...
  <!-- Такая же зарезервированная строка, как у Input/Select/Button (h-4, всегда пустая —
       у FileAttach нет валидации), чтобы высота совпадала при совместном размещении в одной
       строке (items-end) с полем ввода, селектом или кнопкой. -->
