...
| `label` | `object` | `-` | Настройки заголовка карусели |
| `label.name` | `string` | `""` | Текст заголовка карусели |
| `label.class` | `string` | `"text-left"` | CSS-классы для стилизации текста заголовка |
...
Компонент не принимает коллбэк-пропсы и не генерирует событий.
