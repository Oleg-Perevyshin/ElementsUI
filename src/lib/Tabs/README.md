...
| `wrapperClass`     | `string`                                                                                                                                               | `""`                                                                               | Дополнительные CSS-классы для внутренней обёртки полосы вкладок (например `justify-*`)                                                                                                                                                                        |
...
| `items[].class`    | `string`                                                                                                                                               | `undefined`                                                                        | CSS-классы для стилизации вкладки; `flex-row`/`flex-col`/`flex-row-reverse`/`flex-col-reverse` — позиция иконки относительно текста; `flex-1` — вкладка растягивается на равную долю ширины (учитывает отступы между кнопками), `w-auto` — ширина по контенту |
