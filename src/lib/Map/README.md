...
| trackEnabled | boolean                                              | $bindable(false)        | Включает отрисовку траектории движения устройств                  |
| trackLength  | number                                               | $bindable(1000)          | Максимальное количество последних точек в траектории на устройство (100 / 500 / 1000 / 5000 / 10000 / 50000) |
